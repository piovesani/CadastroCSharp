...
namespace SistemaCadastro
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            comboC.Items.Add("Casado");
            comboC.Items.Add("Solteiro");
            comboC.Items.Add("Viuvo");
            comboC.Items.Add("Divorciado");

            comboC.SelectedIndex = 0;
        }

        
        private void btnExcluir_Load(object sender, EventArgs e)
        {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            Pessoa p = new Pessoa
            {
                ...
                EstadoCivil = comboC.SelectedItem.ToString(),
        ...
        private void lista_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            comboC.SelectedItem = p.EstadoCivil;
